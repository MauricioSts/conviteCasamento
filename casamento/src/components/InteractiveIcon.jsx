...
const InteractiveIcon = ({ iconType, label, onClick }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 xl:w-28 xl:h-28 rounded-full bg-wedding-pink flex items-center justify-center shadow-sm transition-all duration-300 group-hover:bg-wedding-rose group-hover:shadow-md flex-shrink-0 min-w-[56px] min-h-[56px] sm:min-w-[64px] sm:min-h-[64px] md:min-w-[80px] md:min-h-[80px]"
      >
        <motion.div
